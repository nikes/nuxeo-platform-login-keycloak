...
public class DeploymentResult {
    ...
    public DeploymentResult invokeOn(AdapterDeploymentContext deploymentContext) {
        ...
        if (httpServletRequest instanceof HttpServletRequestWrapper) {
            httpServletRequest = unwrapRequestFacade((HttpServletRequestWrapper) httpServletRequest);
        }
    ...
    private RequestFacade unwrapRequestFacade(HttpServletRequestWrapper requestWrapper) {
        try {
            Method m = HttpServletRequestWrapper.class.getDeclaredMethod("_getHttpServletRequest");
            m.setAccessible(true);
            return (RequestFacade)m.invoke(requestWrapper);
